...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
         ...
         KC_TRNS, KC_TRNS, LCTL(KC_DEL), LCTL(KC_BSPC), M(SWITCH_TAB), KC_TRNS, KC_TRNS,
         KC_TRNS, KC_TRNS, KC_DEL, KC_BSPC, M(SWITCH_APP), KC_TAB,
         KC_TRNS, KC_TRNS, M(DELETE_END_LINE), M(DELETE_BEG_LINE), HYPR(KC_B), KC_TRNS, KC_TRNS,
  ...
  KEYMAP(
         ...
         KC_NO, KC_AMPR, KC_BSLASH, KC_SLASH, KC_QUOTE, KC_TRNS,
         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
         KC_TRNS, KC_TRNS,
         KC_TRNS,
